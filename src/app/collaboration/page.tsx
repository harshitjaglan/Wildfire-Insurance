  ...
  return (
    <div className="mx-auto max-w-6xl p-6 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Create a claim, invite collaborators, attach items, and track status.
          </p>
        </div>
        ...
        <form action={createClaim} className="grid gap-4 md:grid-cols-2">
          ...
          <div className="grid gap-2">
            <label className="text-sm font-medium">
              Invite collaborators (emails, comma separated)
            </label>
            <input
              name="collaborators"
              className="rounded-xl border px-3 py-2"
      ...
      <div className="space-y-4">
        ...
        {claims.length === 0 && (
          <p className="text-sm text-muted-foreground">
            No claims yet. Create one above and invite others to help.
          </p>
        )}
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Incident on {new Date(c.incidentDate).toLocaleDateString()}
                  </p>
                </div>
              ...
              <div className="mt-4 grid gap-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {c.participants.map(
                    (p: ClaimParticipant & { user: User | null }) => (
                      <span
                        key={p.userId}
              ...
              <div className="mt-4 grid gap-2">
                ...
                <div className="grid gap-2 md:grid-cols-2">
                  {c.items.map((ci: ClaimItem & { item: Item }) => (
                    <div
                      key={ci.id}
                    ...
                    >
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">
                          Value: ${Number(ci.item.value || 0)}
                        </div>
                      </div>
                      <div className="text-xs text-muted-foreground">
                        #{ci.item.id.slice(0, 6)}
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="mt-4 grid gap-3">
                ...
                <div className="grid gap-2">
                  {c.comments.map(
                    (cm: ClaimComment & { author: User | null }) => (
